---
title: "BIO2020 Course Handbook Experimental Design and Statistics 2021-2022"
...
An additional problem is that you have no record of what you have done. You will be taking this course in October to December 2021, but many of the skills you will learn will not be practiced in full until you are doing Stage 3 courses and projects. 
If you do not need to do much statistics after completing this BIO2020 course, will you remember what you need in January 2023 for your Final Year Project or other experiments/surveys? If you have menu-driven software, it is easy to learn, but easy to forget. In contrast, we will use a coding language that is now common in Biology and Zoology, called R. It is (slightly) harder to learn than menu-driven software, but you don't forget it, even 12 months later! Many careers in biology and zoology, both laboratory and field-based, expect applicants to know how to use R. We have therefore developed this course to give you the best employability skills for your CV as well.

Finally, this is the second year in which I have taught on this course. The main change is to substantially increase the numbers of practicals and reduce the numbers of lectures. Passive learning in lectures is not particularly useful for quantitative biologists and zoologists like yourselves. Hands-on experience in practicals will give you much more confidence, and we have provided additional websites and videos for the more theoretical background.
...
There will be an  introductory lecture from Roy Sanderson at the start, and a Questions & Answers lecture at the end, but the focus will be on practical sessions.
...
### Lecture structure
Introductory lectures in Induction Week and the start of term to BIO2020 from Roy Sanderson (Natural & Environmental Science); if needed a final lecture will be offered at the end of term to answer any remaining issues or questions. (Some online pre-recorded lectures by Dr Cristiano Villas, School of Mathematics and Statistics, are available on Canvas for mathematical theory but you will not be tested on this.)
...
**Please work through these websites before attempting the relevant practicals**. 
...
### Computer classes
These are scheduled for six weeks (Week 4 to Week 9) in the main Herschel Building cluster room (Fell) on the first floor. If you wish to use your own laptop or MacBook in these classes then do so, but install R/RStudio before the first practical using the instructions in "Setting up R and RStudio" on the [Canvas website](https://ncl.instructure.com/courses/38776/pages/setting-up-r-and-rstudio?module_item_id=1836048) beforehand as the internal University WiFi is slow. **Please wear face masks during the computer classes** due to the large numbers of students enrolled on the course. If you wish to do most of the practical work in your own time, e.g. at home, for example for personal or health reasons then that is fine. You may want to inform snes.bmsc.support@newcastle.ac.uk if you do this, as the assumption is of 50% minimum attendance.

### Ten-minute videos (TMV)
I am in the process of preparing some short (5 to 10 minutes) animated videos to explain in simple, non-technical terms some quantitative biology concepts. Please read them **before** you do the practical. I have locked Canvas so you will **not** be able to access the practical schedules without looking at the TMV. The videos give basic theory - if you don't understand anything then ask a question at the practical or pop a query into Microsoft Teams. However, last year some students mechanically worked through the practical sessions without any proper understanding of what they were doing, simply because they had not looked at the videos.

### Section Zero on Canvas (Practical on Friday 30th Sept 9:00-11:00)
The Canvas module headed **Section 0: Basic setup - understanding folders files, RStudio defaults and packages** is to get you ready for the rest of the course. It explains how to configure the RStudio so it is easier to use, what the different windows do, how to download Excel data from Canvas, how to import the data into RStudio and calculate a few summary statistics. I've also provided quick-reference sheet for the module (CheatSheet). The latter will probably be incomprehensible at the start of this course, but should soon be a valuable resource to help you later. There is also a Ten Minute Video (TMV) on calculating means, medians, modes etc., and an interactive website [Introducing R and RStudio](https://naturalandenvironmentalscience.shinyapps.io/RstudioInstall/) . **Important** - you will need to view the TMV before you can access the rest of the material for Section Zero!!
...
I have written a small R package (called `bio2020`) to aid teaching on this module. It is not essential to use this package, and if you have any problems using it then let me know.

The R software is pre-installed on University cluster-room and Library PCs.

Whilst R can also be used on your own PC (it is compatible with Windows and MacOS ) we **do not** recommend you do so, until you are experienced in using the software. We will **not** provide you with help during the in-person practicals if you use your own machine. This is because setup of software is difficult (every laptop differs), and it is hard for demonstrators to read small laptop screens. Later in the year, once you are confident in using RStudio, then there is no problem in using your own machine, and we will be happy to help.
