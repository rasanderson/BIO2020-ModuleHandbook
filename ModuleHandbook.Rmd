...
There will be a couple of introductory lectures from Roy Sanderson, but the focus will be on practical sessions.
...
The online tests will be hosted on the Canvas Virtual Learning Environment, but will require you to analyse and interpret data separately. 
The tests will take the form of short-answer / multiple choice / numeric answers.

#### Lectures
Introductory lectures to BIO2020 from Roy Sanderson (Natural & Environmental Science); if needed a final lecture will be offered at the end of term to answer any remaining issues or questions. Some online pre-recorded lectures from Dr Cristiano Villas (School of Mathematics and Statistics) are available on Canvas for background theory but you will not be tested on this.
...
I am in the process of preparing some short (5 to 10 minutes) animated videos to explain in simple, non-technical terms some quantitative biology concepts. These are new for 2020-21 and hopefully you will find them useful.
